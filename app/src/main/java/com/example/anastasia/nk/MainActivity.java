package com.example.anastasia.nk;
    ...
    public class NewThread extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg) {
            ...
            try {
                ...
                //doc = Jsoup.connect("http://dajver.blogspot.ru/2013/11/android.html").get();
                doc  = Jsoup.connect("https://nk.primorsky.ru/?page_id=11164")
                      .timeout(60000).validateTLSCertificates(false).get();
                // задаем с какого места, я выбрал заголовке статей
                title = doc.select(".vc_responsive");
